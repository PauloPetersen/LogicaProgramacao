/*15_Ago_22 - Lista 3 - Exercício 1 - O “Programa de fidelidade” solicitou a criação do sistema “Ver os seus
...
programa
{
	...
	inteiro cupons
		...
		escreva("Parabéns, você possui um total de ", cupons, " pontos.")
